...
import type { WorkOrderSuperviseApi } from '#/models/work_order/supervise';
...
export function useSchema(): VbenFormSchema[] {
  return [
    ...
    },
    {
      ...
      label: '督办意见',
      rules: z.string().min(1, $t('ui.formRules.required', ['督办意见'])).max(100, $t('ui.formRules.maxLength', ['督办意见', 100])),
    },
    {
      component: 'Input',
      fieldName: 'external_refuse_di_ids',
      label: '督办单位名称',
    },
    {
      component: 'Input',
      fieldName: 'external_refuse_di_ids_hide',
      label: '督办单位ID',
    },
    {
      component: 'Input',
...
export function useColumns(
  onActionClick?: OnActionClickFn<WorkOrderSuperviseApi.WorkOrderSupervise>,
): VxeTableGridOptions<WorkOrderSuperviseApi.WorkOrderSupervise>['columns'] {
  return [
    {
      field: 'id',
      title: 'ID',
    ...
    {
      field: 'external_refuse_di_ids',
      title: '督办单位名称',
    },
    {
      field: 'external_refuse_di_ids_hide',
      title: '督办单位ID',
    },
    {
      field: 'remark',
    ...
    },
    {
      ...
      cellRender: {
        attrs: {
          nameField: 'name',
          nameTitle: $t('work_order.supervise.name'),
          onClick: onActionClick,
        },
        name: 'CellOperation',
        options: [
          op('work_order:supervise:edit', 'edit'),
          op('work_order:supervise:delete', 'delete'),
        ],
      },
      field: 'action',
      fixed: 'right',

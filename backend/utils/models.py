...
class CoreModel(models.Model):
    ...
    update_time = models.DateTimeField(auto_now=True, null=True, blank=True, help_text="修改时间", db_comment="修改时间")
    create_time = models.DateTimeField(auto_now_add=True, null=True, blank=True, help_text="创建时间",
                                           db_comment="创建时间")
    is_deleted = models.BooleanField(default=False, db_comment='是否软删除')
